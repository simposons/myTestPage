(function (config) {
    ...
    g.AA = {
        ...
        send: function () {
            ...
            for (b in this.Ij)
                ...
                } a.length && (a = ["type=nfl", "k=" + g.r.key, "m=" + (g.l.ba ? 1 : 0), "pf=" + g.l.Ez, "v=" + g.r.nn, "branch=JSAPI", "log=" + a.join("!")], a = g.r.vc + "://webapi.amap.com/count?" +
    ...
    g.r = {
        ...
        key: "c683cce53ba1a14364505253fc949b9b",
        vc: "http",
    ...
    function nc(a) {
        ...
        "https" === b && (g.r.cAa = "wss", g.r.Zd = g.r.Zd.replace("http", "https"), g.r.OD = g.r.OD.replace("http", "https"), g.r.WJ = g.r.WJ.replace("http", "https"), g.r.wU = g.r.wU.replace("http", "https"), g.r.SK = g.r.SK.replace("http", "https"), g.r.TK = g.r.TK.replace("http", "https"), g.r.TE = g.r.TE.replace("http", "https"), g.r.BL = g.r.BL.replace("http", "https"), g.r.VI = g.r.VI.replace("http",
            "https"));
        ...
        var b = a.da.extend({
            ...
            z3: function (b) {
                ...
                for (var d = 0, e = b.length; d < e; d++)
                    if (a.o.hi && b[d] instanceof a.o.hi && b[d].ga && b[d].ga.length && (-1 !== b[d].ga.indexOf("building") || -1 !== b[d].ga.indexOf("poilabel")) && b[d].La) {
                        ...
                        mta: function (a, b) {
                            ...
                            if (!this.X4(a, function (a, b) {
                                ...
                                q.onreadystatechange = function () {
                                    if (4 === q.readyState && 0 === q.status) q.Mt || (q.Mt = !0, f.Ml(l, b), q.onreadystatechange = null, k ? f.A0(q) : delete f.Wk[q.xE]), q = null;
                                    else if (!q.Mt)
                                        if (3 === q.readyState) {
                        ...
                        $D: function (a) {
                            function b(d, p, r) {
                                ...
                                if (d && "loaded" !== d.status && -1 !== m.indexOf(t))
                                    if ("limg" === t) p = h[1], d.qd = p, "string" === typeof p.b && (p.b = w.bB(p.b)), r = "", (r = "object" === typeof p.u ? p.u.url : p.u) && (p.u = {
                                        url: r,
                                        Fk: "limg-" + d.key + "-" + f
                                    });
                                    else {
            ...
            try {
                ...
                if (b)
                    if (g.TJ = 0, g.SJ = 0, "string" == typeof b && "style_" == b.substr(0, 6)) {
                        var c = this,
                            d, e = b.slice(6);
                        32 == e.length ? (c.js = !0, g.r.Xpa = g.r.VI + "style_local/", d = g.r.vc + "://restapi.amap.com/v4/sdk/map/styles?styleid=" + e + "&key=" + g.r.key + "&sdkType=abroad_js_json&s=rsv3", d += "&platform=JS&logversion=2.0",
        ...
        Bta: function (a) {
            ...
            if (g.l.Ie || g.Ve) a();
                ...
                if (c) b(), a();
                    ...
                    f.id = "amap_anole_js";
                    f.src =
                        window.__AMapStyleSource || g.r.vc + "://vdata.amap.com/style?v=" + g.r.nn + "&key=" + g.r.key + "&mapstyle=normal";
                    c = document;
    ...
    B.C.Haa = B.C.Hh.extend({
        ...
        setText: function (a) {
            ...
            if (b) {
                var b = b.ag,
                    c = this.yn(b, this); - 1 !== c && (b[c].data.txt = void 0 == a.content ? b[c].data.txt : a.content, b[c].opts.text = g.extend({}, b[c].opts.text, a), a.style && (b[c].opts.text.style = g.extend({}, b[c].opts.text.style, a.style)), this.f.Jo())
            }
        },
        setTop: function () {
            var a =
        ...
        getSerializedPath: function () {
            ...
            for (var a = this.get("path", null, !0), b = [], c = 0, d = a.length; c < d; c++) {
                ...
                if (e instanceof g.U) {
                    var f = [];
                    if (e.controlPoints)
                        for (var h = 0, k = e.controlPoints.length; h < k; h++) f.push(e.controlPoints[h].DR()), f.push(e.controlPoints[h].AR());
                    f.push(e.DR());
                    f.push(e.AR());
                    b.push(f)
                } else b.push(e)
    ...
    B.C.Et = B.C.Ec.extend({
        ...
        Ur: function () {
            ...
            if (c && d)
                for (var c = g.a.Ja(c), e = a.radius || this.get("radius"), f = d.Ab(c), a = f.x, f = f.y, h = g.a.map(e, function (a) {
    ...
    g.Rb = g.da.extend({
        ...
        styleUrlChanged: function () {
            if (this.B.Ei) {
                ...
                if (a !== this.Dm) {
                    ...
                    "normal" === c ? (this.Dm = "", this.set("nolimg", !!this.B.get("nolimg_param")), this.set("style", ""), this.Nu = "") : (this.hA = !0, this.set("nolimg", !0), b = new g.jb.yb(32 > c.length ? g.r.vc + "://webapi.amap.com/style?name=" + c + "&key=" + g.r.key : g.r.vc + "://webapi.amap.com/v4/map/styles?styleid=" +
        ...
        drawChanged: function () {
            ...
            if (d) {
                ...
                for (b = 0, c = this.uq.length; b < c; b += 1) this.uq[b].swa(), this.uq[b].bDa(), this.G("click", this.uq[b].NEa, this)
        },
        Xd: function (a, b, c) {
    ...
    g.Rb.Gb({
        ...
        ZK: function (a, b, c, d) {
            ...
            if (f || h) {
                ...
                if (c) f && (b ||
                    (this.q("zoomstart"), this.qa("zoomstart")), this.set("zoom", a), this.qa("zoomchange"), this.qa("zoomend"), this.q("zoomend")), h && (k || d || (this.qa("movestart"), this.q("movestart")), this.set("centerCoords", e), this.qa("mapmove"), this.q("moveend", {
                    L5: d
    ...
    g.o.qb = g.o.Yb.extend({
        ...
        tileFunChanged: function () {
            ...
            this.Do = function (b, c, d) {
                ...
                if (!b.Is || b.Is.sn) b.loaded = !1, b.Is = ("3D" === this.e.B.view.type ? g.sm.sta : g.sm.nz).call(g.sm, e, function (a) {
                    b.Is = null;
                    a ? c(a) : d()
                }, !1)
            }
            ...
            do {
                ...
                for (var l = d.length - 1; 0 <= l; l -= 1) {
                    ...
                    if (g.I.ah(a.I, m.I))
                        ...
                        if (b) c.push(m);
                        else if ("undefined" === typeof e || m.type === e) m = m.We, "undefined" !== typeof f ? h[g.a.xb(m)] = m : c.push(m)
                }
            } while (0 < k.length);
        ...
        nq: function (a, b, c, d) {
            ...
            if (Math.floor(e) !== e) b(c, f);
                ...
                if (e = f.An([a[0] - e, a[1] - h, a[0] + e, a[1] + h])) {
                    ...
                    else if ("AMap.Text" == h.Tp) l = h.get("params"), l.visible && h.fa && g.g.HD(d, h.fa, "amap-markers") && c.push(h);
                    else {
                        if (l = h.get("params"), l.visible && h.fa)
                            if (l.shape)
                                for (k = k.za, s = l.Rp % 360, u = [a[0], a[1]], s && (v = (a[0] -
                                        k[0]) / this.T, w = (a[1] - k[1]) / this.T, t = Math.PI * s / 180, s = Math.cos(-t), x = Math.sin(-t), t = v * s - w * x, v = v * x + w * s, u[0] = k[0] + t * this.T, u[1] = k[1] + v * this.T), m = h.width * this.T, n = h.height * this.T, p = l.offset.x * this.T, r = l.offset.y * this.T, m = g.I.VP([
                                        [u[0] - m - p, u[1] - n - r],
                                        [u[0] - p, u[1] - r]
    ...
    g.M.Vi = g.M.Yb.extend({
                ...
                var e, f, h, k, l, m,
                    n, p = function () {
                        ...
                        for (e = a.length - 1; 0 <= e; e -= 1)
                            for (f = a[e], h = [], k = [], f.WT = h, f.Kv = k, l = f.length - 1; 0 <= l; l -= 1) m = f[l], n = m.ta, c.f.e.Te.ME(n.x, n.y, n.z, function () {
                                var c = l;
                                return function (e) {
        ...
        hp: function (a, b) {
            ...
            for (x = e.Jc; x <= e.Ic; x += 1)
                for (p.x = x, y = e.hc; y <= e.tc; y += 1) p.y = y, k = this.Sy(p), this.bu(k), v = !1, k.Ba ? (k.de = this.de, this.uv(c, x, y) && (m.push(k), this.Pk && (k.gd !== this.gd || 1 > k.hx) && (v = !0))) : (q = !1, this.uv(c, x, y) && (v = !0), k.status && !k.Ke || this.me !== d || this.Gw && !this.uv(this.Gw, x, y) || l.push(k)), v && n.push(k);
            ...
            if (!d && this.aj)
                for (x = !f.length || this.ok ? b.Ya[0] : Math.max(b.Ya[0], this.fb - 2), Math.max(x, this.fb - this.aha), r = this.fb - 1; n.length && r >= x; r -= 1) {
                    m = [];
                    y = {};
                    l = n;
                    n = [];
...
})(["c683cce53ba1a14364505253fc949b9b", [113.525438, 37.434872, 115.483612, 38.763298, 114.502461, 38.045474], "https://webapi.amap.com", 1, "1.4.15", null, "130100", "", true, false, false, true, "1614103611-20201123-1", false, "D", "3_21_03_22_00"])